...
import { Asset, Conversation, Snapshot, SnapshotQuery, User } from '../types';
...
export const readSnapshots = async (token: string, query?: SnapshotQuery): Promise<Snapshot[]> => request(token)('/snapshots', query);
