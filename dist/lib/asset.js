...
exports.pay = pay;
var checkIsPaid = function (p) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, (0, http_1.mixinRequest)("/payments", {}, "post", p)];
}); }); };
...
var openTransfer = function (user_id) {
    return (0, http_1.mixinSchema)("transfer/" + user_id);
};
...
var removeAddress = function (address) {
    ...
    (0, http_1.mixinSchema)('address', __assign(__assign({}, address), { action: 'delete' }));
};
